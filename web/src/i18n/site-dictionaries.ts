...
const dicts = {
  vi: {
    ...
    footer: {
      ...
      copyright: "Sophchem Vietnam. Bảo lưu mọi quyền.",
      description: "Sophchem là đối tác cung ứng nguyên liệu công nghiệp & hóa chất đa quốc gia uy tín. Chúng tôi cam kết cung cấp nguồn nguyên liệu chất lượng cao tuân thủ các quy trình kiểm định nghiêm ngặt theo tiêu chuẩn quốc tế như ISO, HACCP, HALAL, Kosher và FDA.",
    ...
    recruitment: {
      ...
      subtitle: "Gia nhập đội ngũ Sophchem Việt Nam để cùng phát triển chuỗi cung ứng nguyên liệu công nghiệp & hóa chất hàng đầu.",
    ...
    contact: {
      ...
      successDesc: "Cảm ơn bạn đã liên hệ với Sophchem. Chúng tôi sẽ phản hồi lại thông tin qua email trong thời gian sớm nhất.",
      unknownError: "Đã xảy ra lỗi không xác định. Vui lòng thử lại sau.",
    },
    about: {
      title: "VỀ CHÚNG TÔI",
      overview: "Tổng quan doanh nghiệp",
      description: "Sophchem là một công ty thương mại đa quốc gia có trụ sở tại Việt Nam, với hoạt động cốt lõi được chia thành hai phân khúc sản phẩm chính:",
    ...
    home: {
      ...
      partnerDesc: "Sophchem Vietnam cung cấp giải pháp nguồn nguyên liệu toàn diện cho ngành công nghiệp thực phẩm và mỹ phẩm, kết nối tinh hoa toàn cầu đến doanh nghiệp của bạn.",
      ...
      aboutDesc: "Sophchem là một công ty thương mại đa quốc gia có trụ sở tại Việt Nam, tập trung vào hai phân khúc chính là Sản phẩm Công nghiệp và Sản phẩm Hóa chất. Đối với mảng hóa chất, chúng tôi sở hữu mạng lưới cung ứng đáng tin cậy phục vụ các tiêu chuẩn quốc tế ISO, HACCP, HALAL, Kosher, FDA.",
      value1Title: "Năng lực chuyên sâu",
      ...
      whyChooseTitle: "TẠI SAO CHỌN SOPHCHEM",
      ...
      latestNewsDesc: "Cập nhật xu hướng thị trường, kiến thức chuyên ngành và tin tức hoạt động từ Sophchem.",
      readMore: "Đọc tiếp",
    },
    products: {
      foodTitle: "NGUYÊN LIỆU THỰC PHẨM",
  ...
  en: {
    ...
    footer: {
      ...
      hotline: "HOTLINE: 0969 700 520",
      copyright: "Sophchem Vietnam. All rights reserved.",
      description: "Sophchem is a reputable multinational supplier of industrial raw materials & chemicals. We are committed to providing high-quality raw materials complying with strict inspection procedures in accordance with international standards such as ISO, HACCP, HALAL, Kosher, and FDA.",
    ...
    recruitment: {
      ...
      subtitle: "Join the Sophchem Vietnam team to co-develop the leading industrial raw materials & chemical supply chain.",
    ...
    contact: {
      ...
      successDesc: "Thank you for contacting Sophchem. We will respond via email as soon as possible.",
      unknownError: "An unknown error occurred. Please try again later.",
    },
    about: {
      title: "ABOUT US",
      overview: "Company Overview",
      description: "Sophchem is a multinational trading company based in Vietnam, with its core activities divided into two main product segments:",
    ...
    home: {
      ...
      partnerDesc: "Sophchem Vietnam provides comprehensive raw material solutions for the food and cosmetic industries, connecting global excellence to your business.",
      ...
      aboutDesc: "Sophchem is a multinational trading company based in Vietnam, focusing on two main segments: Industrial Products and Chemical Products. For the chemical sector, we possess a reliable supply network serving international standards ISO, HACCP, HALAL, Kosher, FDA.",
      value1Title: "In-depth Capability",
      ...
      whyChooseTitle: "WHY CHOOSE SOPHCHEM",
      ...
      latestNewsDesc: "Update market trends, industry knowledge, and operational news from Sophchem.",
      readMore: "Read More",
    },
    products: {
      foodTitle: "FOOD INGREDIENTS",
