      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-px bg-white/10 rounded-lg overflow-hidden border border-white/10">
            ...
            {/* Value 1 */}
            <ScrollReveal direction="up" delay={100} duration={600} className="h-full">
            ...
            {/* Value 2 */}
            <ScrollReveal direction="up" delay={200} duration={600} className="h-full">
              <div className="bg-[#062013]/80 backdrop-blur-sm p-8 sm:p-10 flex flex-col items-center text-center gap-5 hover:bg-brand-green/30 transition-colors duration-300 group h-full border-t md:border-t-0 border-white/10">
                <div className="w-24 h-24 shrink-0 [perspective:600px]">
                  <div className="w-full h-full flex items-center justify-center transition-transform duration-700 ease-in-out group-hover:[transform:rotateY(180deg)]">
            ...
            {/* Value 3 */}
            <ScrollReveal direction="up" delay={300} duration={600} className="h-full">
              <div className="bg-[#062013]/80 backdrop-blur-sm p-8 sm:p-10 flex flex-col items-center text-center gap-5 hover:bg-brand-green/30 transition-colors duration-300 group h-full border-t md:border-t-0 border-white/10">
                <div className="w-24 h-24 shrink-0 [perspective:600px]">
                  <div className="w-full h-full flex items-center justify-center transition-transform duration-700 ease-in-out group-hover:[transform:rotateY(180deg)]">
            ...
            <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <ScrollReveal direction="up" delay={100} duration={600} className="h-full">
                <Link
                  ...
                  className="relative block aspect-[4/5] md:aspect-square rounded-lg overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 h-full"
                >
