  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start">
        {/* Product Image */}
        <div className="w-full lg:w-[45%] rounded-2xl overflow-hidden bg-gray-55 border border-gray-200 shadow-xs">
          <img
        ...
        <div className="w-full lg:w-[55%] space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed text-justify text-sm sm:text-base">{getVal(product.desc, locale)}</p>
          </div>
