      ...
      <div class="p-4 border-t border-gray-150 bg-gray-50/50">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            <div class="w-8 h-8 rounded-full bg-emerald-150 flex items-center justify-center text-emerald-800 font-bold text-sm">
              {{ $page.props.auth.user ? $page.props.auth.user.name.charAt(0) : 'A' }}
            </div>
            <div class="truncate max-w-[120px]">
              <p class="text-sm font-bold text-gray-950 truncate">{{ $page.props.auth.user ? $page.props.auth.user.name : 'Admin' }}</p>
