<template>
  <CrmLayout :title="isEdit ? 'Sửa danh mục sản phẩm' : 'Thêm danh mục sản phẩm mới'">
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 border-b border-gray-100">
          ...
          <div>
            ...
            <a-select v-model:value="form.type" placeholder="Chọn loại sản phẩm..." class="w-full" size="large">
